...
export default function UpdatePhaseone({data ,per_id,serviceURL,tokenID}) {
    ...
    const changePhaseOne = async(e) =>{
        ...
        await axios.put(`${service}/${person_id}`,ph1Form,{headers: { Authorization: `Bearer ${tokenID}` }})
            ...
            <form className="justify-content-center " onSubmit={changePhaseOne}>
                <div className="row g-3 gap-2 m-2 p-2 rounded" style={{background:'#AAA8F0'}}>
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input className="form-control rounded ms-2 me-2" id="ph1Inp1" type={'number'} name={'ph1_Inp1'} defaultValue={phaseone.phInp1}/>
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input className="form-control rounded ms-2 me-2" id="gestation" type={'number'} name={'gestation'} max={20} defaultValue={phaseone.gestation}/>
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input className="form-control rounded ms-2 me-2" id="parity" type={'number'} name={'parity'} max={20} defaultValue={phaseone.parity}/>
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input className="form-control rounded ms-2 me-2" id="GA" type={'number'} name={'GA'} max={100} defaultValue={phaseone.GA}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="ph1Inp3" className="form-check-input" type={'radio'} name={'ph1_Inp3'} value={`ใช่`} defaultChecked={phaseone.phInp3===`ใช่`}/>
                                <label className="form-check-label text-light" htmlFor="ph1Inp3">{`ใช่`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="ph1Inp3" className="form-check-input" type={'radio'} name={'ph1_Inp3'} value={`ไม่`}  defaultChecked={phaseone.phInp3===`ไม่`}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="hemorrhage" className="form-check-input" type={'radio'} name={'hemorrhage'} value={`ใช่`} defaultChecked={phaseone.hemorrhage===`ใช่`}/>
                                <label className="form-check-label text-light" htmlFor="hemorrhage">{`ใช่`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="hemorrhage" className="form-check-input" type={'radio'} name={'hemorrhage'} value={`ไม่`} defaultChecked={phaseone.hemorrhage===`ไม่`}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="hemorrhage1" className="form-check-input" type={'radio'} name={'hemorrhage1'} value={`ใช่`} defaultChecked={phaseone.hemorrhage1===`ใช่`}/>
                            ...
                            <label className="form-check-label text-light" htmlFor="hemorrhage1">{`ขนาด`}</label>
                                <input className="form-control rounded ms-2 me-2" id="hemorrhage1" type={'number'} name={'hemorrhage1Yes'} defaultValue={phaseone.hemorrhage1Yes}></input>
                                <label className="form-check-label text-light" htmlFor="hemorrhage1">{`ซม.`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="hemorrhage1" className="form-check-input" type={'radio'} name={'hemorrhage1'} value={`ไม่`}  defaultChecked={phaseone.hemorrhage1===`ไม่`}/>
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input className="form-control rounded ms-2 me-2" id="weight" onChange={e=>setW(e.target.value)} type={'number'} name={'weight'} defaultValue={phaseone.weight}/>
                            ...
                            <input className="form-control rounded ms-2 me-2" id="height" onChange={e=>setH(e.target.value)} type={'number'} name={'height'} defaultValue={phaseone.height}/>
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input className="form-control rounded ms-2 me-2" id="ph1Inp5" type={'number'} name={'Hct'} max={100} defaultValue={phaseone.Hct}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="HxPPH" className="form-check-input" type={'radio'} name={'HxPPH'} value={`ใช่`} defaultChecked={phaseone.HxPPH===`ใช่`}/>
                                <label className="form-check-label text-light" htmlFor="HxPPH">{`ใช่`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="HxPPH" className="form-check-input" type={'radio'} name={'HxPPH'} value={`ไม่`} defaultChecked={phaseone.HxPPH===`ไม่`}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="DM" className="form-check-input" type={'radio'} name={'DM'} value={`ใช่`} defaultChecked={phaseone.DM===`ใช่`}/>
                                <label className="form-check-label text-light" htmlFor="DM">{`ใช่`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="DM" className="form-check-input" type={'radio'} name={'DM'} value={`ไม่`} defaultChecked={phaseone.DM===`ไม่`}/>
                                <label className="form-check-label text-light" htmlFor="DM">{`ไม่`}</label>
                            </div>
                        </div>
                        <div className="input-group mb-2 align-items-center">
                            <label htmlFor="PIH" className="col-form-label text-light" >{`เคยมีประวัติการตกเลือด`}</label>
                            <div className="form-check ms-4">
                                <input id="PIH" className="form-check-input" type={'radio'} name={'PIH'} value={`ใช่`} defaultChecked={phaseone.PIH===`ใช่`}/>
                                <label className="form-check-label text-light" htmlFor="PIH">{`ใช่`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="PIH" className="form-check-input" type={'radio'} name={'PIH'} value={`ไม่`} defaultChecked={phaseone.PIH===`ไม่`}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="hemorrhage3" className="form-check-input" type={'radio'} name={'hemorrhage3'} value={`ใช่`} defaultChecked={phaseone.hemorrhage3===`ใช่`}/>
                                <label className="form-check-label text-light" htmlFor="hemorrhage3">{`ใช่`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="hemorrhage3" className="form-check-input" type={'radio'} name={'hemorrhage3'} value={`ไม่`} defaultChecked={phaseone.hemorrhage3===`ไม่`}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="hemorrhage4" className="form-check-input" type={'radio'} name={'hemorrhage4'} value={`ใช่`} defaultChecked={phaseone.hemorrhage4===`ใช่`}/>
                            ...
                            <div className="form-check m-4">
                                ...
                                <input className="form-control rounded " id="hemorrhage4" type={'number'} name={'hemorrhage4Yes'} defaultValue={phaseone.hemorrhage4Yes}></input>
                                <label className="form-check-label text-light" htmlFor="hemorrhage4">{`ครั้ง.`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="hemorrhage4" className="form-check-input" type={'radio'} name={'hemorrhage4'} value={`ไม่`} defaultChecked={phaseone.hemorrhage4===`ไม่`}/>
                                <label className="form-check-label text-light" htmlFor="hemorrhage4">{`ไม่`}</label>
                            </div>
                        </div>
                        <div className="input-group mb-2  align-items-center">
                            <label htmlFor="hemorrhage5" className="col-form-label text-light" >{`มารดาเคยมีประวัติการขูดมดลูกก่อนการตั้งครรภ์`}</label>
                            <div className="row">
                                <div className="col-auto form-check ms-4">
                                    <input id="hemorrhage5" className="form-check-input" type={'radio'} name={'hemorrhage5'} value={`กิน`} defaultChecked={phaseone.hemorrhage5 === `กิน`}/>
                                    <label className="form-check-label text-light" htmlFor="hemorrhage5">{`กิน`}</label>
                                </div>
                                <div className="col-auto form-check ms-4">
                                    <input id="hemorrhage5" className="form-check-input" type={'radio'} name={'hemorrhage5'} value={`ฉีด`}  defaultChecked={phaseone.hemorrhage5 === `ฉีด`}/>
                                    <label className="form-check-label text-light" htmlFor="hemorrhage5">{`ฉีด`}</label>
                                </div>
                                <div className="col-auto form-check ms-4">
                                    <input id="hemorrhage5" className="form-check-input" type={'radio'} name={'hemorrhage5'} value={`ฝั่ง`} defaultChecked={phaseone.hemorrhage5 === `ฝั่ง`}/>
                                    <label className="form-check-label text-light" htmlFor="hemorrhage5">{`ฝั่ง`}</label>
                                </div>
                                <div className="col-auto form-check ms-4">
                                    <input id="hemorrhage5" className="form-check-input" type={'radio'} name={'hemorrhage5'} value={`ใส่ห่วง`} defaultChecked={phaseone.hemorrhage5 === `ใส่ห่วง`}/>
                                    <label className="form-check-label text-light" htmlFor="hemorrhage5">{`ใส่ห่วง`}</label>
                                </div>
                                <div className="col-auto form-check ms-4">
                                    <input id="hemorrhage5" className="form-check-input" type={'radio'} name={'hemorrhage5'} value={`ไม่เคย`} defaultChecked={phaseone.hemorrhage5 === `ไม่เคย`}/>
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input className="form-control rounded ms-2 me-2" id="ph1Inp6" type={'number'} name={'ph1_Inp6'} defaultValue={phaseone.phInp6}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="hemorrhage6" className="form-check-input" type={'radio'} name={'hemorrhage6'} value={`ใช่`} defaultChecked={phaseone.hemorrhage6 === `ใช่`}/>
                                <label className="form-check-label text-light" htmlFor="hemorrhage6">{`ใช่`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="hemorrhage6" className="form-check-input" type={'radio'} name={'hemorrhage6'} value={`ไม่`} defaultChecked={phaseone.hemorrhage6 === `ไม่`}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="hemorrhage7" className="form-check-input" type={'radio'} name={'hemorrhage7'} value={`ใช่`} defaultChecked={phaseone.hemorrhage7 === `ใช่`}/>
                                <label className="form-check-label text-light" htmlFor="hemorrhage7">{`ใช่`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="hemorrhage7" className="form-check-input" type={'radio'} name={'hemorrhage7'} value={`ไม่`} defaultChecked={phaseone.hemorrhage7 === `ไม่`}/>
                        ...
                        <div className="input-group mb-2 align-items-center">
                            ...
                            <div className="form-check ms-4">
                                <input id="hemorrhage8" className="form-check-input" type={'radio'} name={'hemorrhage8'} value={`ใช่`} defaultChecked={phaseone.hemorrhage8 === `ใช่`}/>
                                <label className="form-check-label text-light" htmlFor="hemorrhage8">{`ใช่`}</label>
                            </div>
                            <div className="form-check ms-4">
                                <input id="hemorrhage8" className="form-check-input" type={'radio'} name={'hemorrhage8'} value={`ไม่`} defaultChecked={phaseone.hemorrhage8 === `ไม่`}/>
                        ...
                        <div className="input-group row mb-2">
                            ...
                            <input className="form-control rounded ms-2 me-2" id="ph1Inp7" type={'number'} name={'ph1_Inp7'} defaultValue={phaseone.phInp7}/>
                        </div>
                </div>
...
UpdatePhaseone.getLayout = function getLayout(page){
    return(
        <Layout>
            <Sidebar/>
            {page}
